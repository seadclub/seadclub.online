...
Ключові слова "МУСТ", "НЕ МУСТ", "

ВИМАГАЄТЬСЯ", "МАЄ", "НЕ ПОВИННО", "ПОВИННО", "НЕ ПОВИННО", "РЕКОМЕНДОВАНО", "МОЖЕ", та "ОПЦІОНАЛЬНО" в цьому документі слід розглядати так, як описано в [RFC 2119](https://tools.ietf.org/html/rfc2119).

1. Програмне забезпечення, яке використовує Семантичне версіонування, МУСТ оголошувати публічний API. Це API
...
1. Звичайний номер версії МУСТ мати форму X.Y.Z, де X, Y та Z є
невід'ємні цілі числа і НЕ МОЖЕ містити ведучих нулів. X - це
основна версія, Y - версія мінора, а Z - версія патча.
Кожен елемент МУСТ збільшуватися числово. Наприклад: 1.9.0 -> 1.10.0 -> 1.11.0.

1. Після випуску версійного пакета, зміст цієї версії
МУСТ НЕ МОЖЕ бути змінений. Будь-які зміни МУСТ бути випущені як нова версія.
...
1. Патч-версія Z (x.y.Z | x > 0) МУСТ бути збільшена, якщо вводяться тільки сумісні з попередніми
виправлення помилок. Виправлення помилок визначається як внутрішня
зміна, яка виправляє невірну поведінку.

1. Версія мінора Y (x.Y.z | x > 0) МУСТ бути збільшена, якщо вводиться новий сумісний з попередніми
функціонал для публічного API. Вона МУСТ також бути
...
МУСТ бути скинута на 0, коли збільшується версія мінора.

1. Основна версія X (X.y.z | X > 0) МУСТ бути збільшена, якщо вводяться несумісні з попередніми
зміни до публічного API. Вона МОЖЕ також включати зміни рівня мінора
та патча. Патч та мінор версії МУСТ бути скинуті на 0, коли збільшується
основна версія.
...
Оригінальний джерело: [https://semver.org/](https://semver.org/)

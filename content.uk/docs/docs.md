...
1. [Конвенції Коду](/uk/docs/code-conventions)
2. [Вказівки проекту](/uk/docs/project-guidelines)
3. [Стандарти документації](/uk/docs/documentation-standards)
4. [Початок роботи](/uk/docs/getting-started)
5. [Внесення в проекти](/uk/docs/contributing)
6. [Кодекс Поведінки](/uk/docs/code-of-conduct)
